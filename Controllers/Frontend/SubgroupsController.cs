...
namespace IpDeputyApi.Controllers.Frontend
{
    ...
    [Route("api/frontend/subgroup")]
    [ApiController]
    public class SubgroupsController : ControllerBase
    {
        private static Serilog.ILogger Logger => Serilog.Log.ForContext<SubgroupsController>();
        ...
        public async Task<ActionResult<int>> Delete(int id)
        {
            ...
            var model = await _context.Subgroups.FirstOrDefaultAsync(x => x.Id == id);
